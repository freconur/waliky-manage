...
const ListSidebar = ({ openSidebar, pruebita }: Props) => {
	...
	return (
		<ul className="mt-5">
			...
			<li  onClick={() => pruebita(!openSidebar)} className=" text-sm items-center gap-x-4 cursor-pointer overflow-hidden  rounded-md mt-2 capitalize whitespace-nowrap">
				{/* <Link to="/registro-de-productos" className="w-56 p-2"> */}
				<div onClick={() => setProductActive(!productActive)} className="flex overflow-hidden duration-300 p-2 rounded-md hover:bg-red-200 text-gray-300 hover:text-gray-500">
				...
				{productActive && openSidebar && 
					<ul className={`duration-1000  bg-white rounded-lg scale-100 overflow-hidden `}>
						<li className="text-gray-400  p-3 text-md flex items-center gap-x-4 cursor-pointer capitalize   hover:bg-red-200 hover:text-gray-500 whitespace-nowrap duration-300 font-semibold">
							<Link to="registro-de-productos" className="ml-10">
							mis productos
							</Link>
						</li>
						<li className="text-gray-400  p-3 text-md flex items-center gap-x-4 cursor-pointer capitalize   hover:bg-red-200 hover:text-gray-500 whitespace-nowrap duration-300 font-semibold">
							<Link to="/agregar-producto" className="ml-10">
							agregar producto
							</Link>
						</li>
					</ul>
